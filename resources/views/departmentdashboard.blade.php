    ...
    <section>
        @if ($empty != 'yes')
                ...
                <div class="col-lg-12">
                    <div class="box-outer-div padding-3">
                        <div class="row">
                            ...
                            <div class="col-md-3"><span class="due-date-css shadow">From:{{ $as->duration_from
                            }}</span></div>
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="dept" id="dept">
                                        ...
                                        @foreach ($departments as $item)
                                            <option value="{{$item->id}}" {{($dept == $item->id) ? "selected" : ""}}>{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-3">
            ...
            @if ($fullscore)
                ...
                @if ($check == 'tdist')
                <div class="row mt-2 mb-2" id="tdistbumain">
                    <div class="col-md-12">
                ...
                function normalitytestcall(file) {
                    $.get("http://staging-epes.drupalised.com/rstat/" + file, function (testdata) {
                        ...
                        <table class="table table-striped table-responsive">
                                <tr>
                                    <th>anderson pvalue</th><td>${testdata[0].anderson_pval}</td>
                                </tr>
                                <tr>
                                    <th>shapiro pvalue</th><td>${testdata[0].shapiro_pval}</td>
                                </tr>
                            </table>
                        `);
                        if (testdata[0].anderson_pval > 0.1) {
                            normaldist();
                        } else {
