                            ...
                            <div class="col-sm-10">
                                ...
                                @if(CRUDBooster::isCreate() || CRUDBooster::isUpdate())
                                    ...
                                    @if(CRUDBooster::isCreate() && $button_addmore==TRUE && $command == 'add')
                                        <input type="submit" name="submit" value='{{ $submit_btn != "" ? $submit_btn:trans("crudbooster.button_save_more")}}' class='btn btn-success'>
                                    @endif

                                    @if($button_save && $command != 'detail')
                                        <input type="submit" name="submit" value='{{ $submit_btn2 != "" ? $submit_btn2:trans("crudbooster.button_save")}}' class='btn btn-success'>
                                    @endif
