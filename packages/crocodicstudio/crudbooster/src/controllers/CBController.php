...
class CBController extends Controller
{
    ...
    public function cbLoader()
    {
        ...
        $this->data['btn_next'] = $this->btn_next;
        $this->data['submit_btn'] = $this->submit_btn;
        $this->data['submit_btn2'] = $this->submit_btn2;
...
//         $this->arr[$this->primary_key] = $id = CRUDBooster::newId($this->table); //error on sql server
        $Last_id = DB::table($this->table)->insertGetId($this->arr);
