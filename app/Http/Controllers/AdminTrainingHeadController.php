<?php namespace App\Http\Controllers;
	...
	class AdminTrainingHeadController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Reporting to","name"=>"parentID","join"=>"training_head,name"];
			// $this->col[] = ["label"=>"Company name","name"=>"company_id","join"=>"companies,company_name"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10','placeholder'=>'Please provide name of Head Trainer'];
			$this->form[] = ['label'=>'Reporting to','name'=>'parentID','type'=>'select','width'=>'col-sm-10','datatable'    =>'training_head,name','datatable_where'=>'company_id ='.getCompanyID()];
	    ...
	    */
	    public function hook_before_add(&$postdata) {
	        //Your code here
            \LogActivity::addToLog('Added New Head Trainers');
	    }
	    ...
	    */
	    public function hook_after_edit($id) {
	        //Your code here
            \LogActivity::addToLog('Updated Head Trainers Details');
	    }
	    ...
	    */
	    public function hook_after_delete($id) {
	        //Your code here
            \LogActivity::addToLog('Deleted Head Trainers Details');
	    }
