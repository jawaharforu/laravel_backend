<?php namespace App\Http\Controllers;
	...
	class AdminTestimonialController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Image','name'=>'image','type'=>'upload','validation'=>'required|image|max:3000|image','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			...
			$this->form[] = ['label'=>'Company Id','name'=>'company_id','type'=>'hidden','width'=>'col-sm-10'];
