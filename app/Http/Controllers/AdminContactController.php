<?php namespace App\Http\Controllers;
	...
	class AdminContactController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Countrycode","name"=>"countrycode"];
			...
			$this->form[] = ['label'=>'Countrycode','name'=>'countrycode','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Countrycode","name"=>"countrycode","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
