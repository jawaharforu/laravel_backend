<?php namespace App\Http\Controllers;
	...
	class AdminDepartmentsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Parent Department","name"=>"parentid","join"=>"departments,name"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Name','name'=>'name','class'=>'selector','type'=>'text','validation'=>'required|string|min:1|max:70','width'=>'col-sm-10','placeholder'=>'Please provide name of the department'];
			$this->form[] = ['label'=>'Visiblity For','name'=>'visiblity_for','type'=>'hidden','value'  => getCompanyID()];
			$this->form[] = ['label'=>'Parent Department','name'=>'parentid','type'=>'select','width'=>'col-sm-10',"datatable"=>"departments,name",'datatable_where'=>'company_id ='.getCompanyID().' OR company_id =0'];


                if(CRUDBooster::isSuperadmin()):
                    $this->form[] = ['label' => 'Company Id', 'name' => 'company_id', 'type' => 'hidden', 'value'=> 0];
                else:
                    $this->form[] = ['label' => 'Company Id', 'name' => 'company_id', 'type' => 'hidden', 'value'=>
                        getCompanyID()];
                endif;
	    ...
	    */
	    public function hook_after_edit($id) {
	        //Your code here
            \LogActivity::addToLog('Department data updated');
	    }
	    ...
	    */
	    public function hook_after_delete($id) {
	        //Your code here
            \LogActivity::addToLog('Department data deleted');
	    }
        ...
        public function getSendMail(){
            ...
            CRUDBooster::sendEmail(['to'=>"edwin@zolipe.com",'data'=>$data,'template'=>'test']);
